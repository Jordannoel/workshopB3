...
<head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="workshop/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">

    <!-- Custom styles for this template -->
    <link href="workshop/css/modern-business.css" rel="stylesheet">
    <style>
        h4{
            color: #ff8a28;
        }
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p>Maybe check if your email or password are good</p>
                            </div>
                            <div class="modal-footer">
                                <button onclick="" type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="container">
    ...
    <!--&lt;!&ndash; Call to Action Section &ndash;&gt;-->
    <!--<div class="row mb-4">-->
    <!--<div class="col-md-8">-->
